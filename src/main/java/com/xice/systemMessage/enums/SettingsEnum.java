...
public enum SettingsEnum {
  ...
  LOGIN_MESSAGE_VISIBILITY("login-message.visibility", MessageVisibilityEnum.GLOBAL, "自定义登录消息可见性（disable：不可见；self：仅自己；nearby：附近玩家；world：当前世界；global：全服务器）"),
  ...
  QUIT_MESSAGE_VISIBILITY("quit-message.visibility", MessageVisibilityEnum.GLOBAL, "自定义登录消息可见性（disable：不可见；self：仅自己；nearby：附近玩家；world：当前世界；global：全服务器）"),
